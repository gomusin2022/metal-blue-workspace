/**
 * CalendarView.tsx - 달력 모듈 (너비 100% 복구 및 중앙 정렬 판)
 */
...
const CalendarView: React.FC<CalendarViewProps> = ({ schedules, onDateClick, onUpdateSchedules }) => {
  ...
  return (
    /* 롤백: 너비를 다시 w-full로 복구하고, box-border를 적용하여 보더를 안쪽으로 포함시킵니다. 
      좌우 밀림을 유도하던 비대칭 여백을 모두 제거했습니다.
    */
    ...
    >
      ...
      {/* 7등분 그리드: justify-items-stretch와 w-full로 화면을 꽉 채우고 내부 콘텐츠를 중앙 정렬 */}
